            ...
            <CardDeck style={{ display: 'flex', flexDirection: 'row' }}>
                <Card style={{ width: '16rem' }}>
                    <Card.Body style={{ textAlign: 'center' }}>
                        <StarFill color="#C99A5C" size={60} /> <p></p>
                        <Card.Title>Support Local Community</Card.Title>
                ...
                <Card style={{ width: '16rem' }}>
                    <Card.Body style={{ textAlign: 'center' }}>
                        <HandThumbsUpFill color="#C99A5C" size={60} /> <p></p>
                ...
                <Card style={{ width: '16rem' }}>
                    <Card.Body style={{ textAlign: 'center' }}>
                        <CapslockFill color="#C99A5C" size={60} /> <p></p>
